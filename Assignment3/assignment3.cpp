...
bool RG::Homework2::assignment3()
{
    ...
    return (typeid(&funk) == typeid(void (*)())) && (typeid(&funk5) == typeid(int (*)())) && (a1 == 5) && (a2 == 5) && (a3 == 9.9) && (typeid(&increase) == typeid(void (*)(int &)))
        && (i1 == 4) && (typeid(&decrease) == typeid(void (*)(int *)))
        && (i2 == 7) 
